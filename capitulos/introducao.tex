...
\item Reduzir a dependência de intervenções manuais constantes por meio de alertas e acionamentos automáticos da bomba de água.
\item Projetar e testar um módulo de monitoramento de pH com sensores IoT integrados ao sistema de controle.
\item Desenvolver e implementar um algoritmo de acionamento automático da bomba de água com base nos sensores de nível e parâmetros de qualidade.
\end{itemize}
