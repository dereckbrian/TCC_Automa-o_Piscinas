...
\begin{table}[H]
    ...
    \label{tab:trabalhos_correlatos_check}
    \resizebox{\textwidth}{!}{%
    \begin{tabular}{lcccccc}
    \hline
    \textbf{Referência} & \textbf{Automação Química (pH)} & \textbf{Monitoramento de Turbidez} & \textbf{Interface Web/IoT} & \textbf{Controle Autônomo (Sensores)} & \textbf{Baixo Custo (Arduino/ESP)} & \textbf{Segurança (Alarme)} \\ \hline
    \citeonline{campos2014automaccao} &  &  & \checkmark &  & \checkmark & \checkmark \\ \hline
    \citeonline{brandao2018sistema} & \checkmark &  &  & \checkmark & \checkmark &  \\ \hline
    \citeonline{boeira2019autopool} & \checkmark &  &  & \checkmark & \checkmark & \checkmark \\ \hline
    \citeonline{sulimann2014automatizacao} & \checkmark &  &  & \checkmark &  &  \\ \hline
    \citeonline{oliveira2023automaccao} &  &  & \checkmark &  & \checkmark &  \\ \hline
    \textbf{Este Trabalho} & \checkmark & \checkmark & \checkmark & \checkmark & \checkmark &  \\ \hline
    \end{tabular}%
    }
    \par \vspace{0.2cm}
