...
\item Implementar o monitoramento automatizado dos níveis de pH, turbidez, temperatura e nível da água, centralizando as informações em uma interface web.
\item Reduzir a dependência de intervenções manuais constantes por meio de alertas do sistema e acionamentos automáticos da bomba de água com base nos parâmetros de qualidade.
\end{itemize}
