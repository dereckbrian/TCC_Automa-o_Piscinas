...
\begin{figure}[H]
    ...
    \includegraphics[width=0.9\textwidth]{imagens/codigo_arduino.png} 
...
\begin{figure}[H]
    ...
    \includegraphics[width=0.9\textwidth]{imagens/codigo_python.png}
    \caption*{Fonte: Autoria própria.}
\end{figure}

Na camada de aplicação, o \textit{back-end} desenvolvido em Spring Boot recebe essas requisições, persiste os dados no banco PostgreSQL e gerencia a lógica de negócios. A Figura \ref{fig:cod_backend} apresenta o \textit{Controller} responsável por receber os dados do sensor e o método para processar o comando de acionamento vindo da interface.

\begin{figure}[H]
    \centering
    \caption{Controller Spring Boot: Recepção de dados e endpoints de controle}
    \label{fig:cod_backend}
    \includegraphics[width=0.9\textwidth]{imagens/codigo_backend.png}
    \caption*{Fonte: Autoria própria.}
\end{figure}
...
\begin{figure}[H]
    ...
    \includegraphics[width=0.9\textwidth]{imagens/codigo_frontend.png}
    \caption*{Fonte: Autoria própria.}
\end{figure}
