...
\section{Fase de Elaboração (\textit{Elaboration})}
    ...
    Para melhor entendimento do sistema, foi desenvolvido um diagrama de caso de uso e diagrama de arquitetura. Tais diagramas, são fundamentais para um fácil entendimento do sistema, a fim de que qualquer pessoa consiga entender de forma rápida e eficiênte. Segue abaixo os diagramas.
    ...
    \begin{figure}[H]
        ...
        \centering
        \label{fig:cont}
        \includegraphics[width=0.72\textwidth]{imagens/Diagrama sem nome.jpg}
