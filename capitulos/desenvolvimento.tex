...
% Essa ineficiência é corroborada por estudos de campo que demonstram as limitações da intervenção humana. Segundo \citeonline{moreira348}, o manejo manual da piscina gera um impacto ambiental severo devido ao método tradicional de aspiração (drenagem): em testes comparativos, a limpeza manual resultou no descarte de 59,3 m³ de água por dia de operação. Em contrapartida, o uso de sistemas automatizados de limpeza permitiu manter a turbidez da água consistentemente abaixo de 2 NTU , superando os picos de 10,82 NTU observados no controle manual, comprovando que a automação dos ciclos de filtragem e monitoramento físico é superior à manutenção empírica.
