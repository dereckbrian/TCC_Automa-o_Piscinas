...
\section{FERRAMENTAS UTILZIADAS PARA AUTOMAÇÃO}
    ...
    \subsection{RUP}
        ...
        De acordo com \cite{vasconcelosconcepccao}, o RUP é composto por estapas bem definidas, que são: Concepção onde acontece a identificação do problema e o objetivo do sistema. Elaboração no RUP é onde é feito a modelagem de casos de uso. Construção consiste na etapa de codificação e integração. Por fim a transição que é feito a implantação de testes práticos em ambiente simulado ou controlado, avaliação de desempenho e ajustes finais.
