...
\section{FERRAMENTAS UTILZIADAS PARA AUTOMAÇÃO}
    ...
    \subsection{Linguagem UML}
        Segundo \cite{castro2013paradigma} a UML \textit{Unified  Modeling  Language} ou Linguagem  de  Modelagem Unificada pode ser definida como é uma linguagem desenvolvida para modelagem de softwares. Sua função é auxiliar engenheiros de softwares no momento de definir as características do sistema, como por exemplo sua estrutura lógica. A utilziação da linguagem UML em desenvolvimento de softwares se torna necessária, pois algumas alplicações podem vir a se tornar muito complexas. A utilziação dessa modelagem serve como intermédio de comunição entre os analistas e usuários facilitando o entendimento do sistema para ambos.
        
        A forma de modelagem mais utilizada é o Diagrama de Caso de Uso, que é utilizado geralmente  nas fases iniciais de levantamento e analise de requisitos. 
