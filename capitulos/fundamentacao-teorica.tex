...
\section{FERRAMENTAS UTILZIADAS PARA AUTOMAÇÃO}
    ...
    \subsection{RUP}
        Segundo \cite{piske2003rup}, o RUP (Rational Unified Process) é uma metodologia com fins de desenvolvimento de software. Assim como todas as metodologias, o RUP possui uma estrutura bem definida, possuindo conceitos, práticas e regras. O conceito de \textit{best pratices} (melhores práticas), é um dos pilares principais do RUP que visa reduzir riscos e possibilitar um desenvolvimento mais eficiênte do projeto, através de regras e práticas. 
        
        Em resumo, o RUP é um processo de software que ofere uma abordagem com uma maior disciplina a fim de garantir uma alta qualidade no desenvolvimento de software \cite{RUPo_quee}. Segundo \cite{moreiraprocessos}, o RUP é iterativo porque o produto pode ser desenvolvido em varias iterações e icrementar porque a cada iteração é adicionado outras funcionalidades.
        %De acordo com \cite{tccPaulo} O RUP lista como efetutuar um efetivo desenvolvimento de software sempre utilizando as boas práticas de desenvolvimento que são:
