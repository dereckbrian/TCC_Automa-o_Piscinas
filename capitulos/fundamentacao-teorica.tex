...
\section{PISCINAS e sua manutenção}
    ...
    \subsection{COMPONENTES BÁSICOS DE UMA PISCINA}
        ...
        \textcolor{blue}{Todos esses componentes tem como objetivo bombear a água em um ciclo contínuo, passando por todos os sistemas, como filtragem e tratamento químico, porém, ainda existem os componeres que são responsáveis por auxiliar na limpeza física, são eles:}

        \subsubsection*{Aspirador de escova}

         \textcolor{blue}{Segundo \cite{benedito2024projeto} o aspirador de escova é um dos itens mais importantes na limpeza física da piscina, tendo como função a aspiração das sujeira acumulada no fundo da piscina.}
        ...
        \subsubsection*{Peneira}
         ...
         \textcolor{blue}{Responsável pela coleta de resíduos como insetos, plásticos ou pequenas folhas que ficam flutuando na superfície da piscina \cite{benedito2024projeto}.}
        ...
        \subsubsection*{Escova}
         ...
         \textcolor{blue}{De acordo com o \cite{benedito2024projeto}, a escova é um dos principais equipamentos na hora de limpar a piscina. Responsável pela limpeza de poeiras e algas na parede da piscina, podendo limpar também as sujeiras do chão.}
        ...
        \subsubsection*{Cabo de alumínio}
         ...
         \textcolor{blue}{A função do cabo de alumínio encaixar com os equipamentos citados. Possui vários tamanhos para uma melhor conforto na hora do manuseio \cite{benedito2024projeto}.}
...
\section{FUNDAMENTOS DA AUTOMAÇÃO RESIDENCIAL}
    ...
    \subsection{CONCEITOS TÉCNICOS DE AUTOMAÇÃO RESIDENCIAL}
       ...
       \textcolor{blue}{Já em uma arquitetura descentralizada, varios controladores podem coexistir que, ligados por um barramento\footnote{Refere-se a um sistema onde a comunicação e a coordenação entre os componentes são distribuídas, sem depender de uma autoridade ou ponto central}, podem compartilhar o controle dos demais dispositivos ligados aos controladores.}
