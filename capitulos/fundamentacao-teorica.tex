...
\section{FERRAMENTAS UTILZIADAS PARA AUTOMAÇÃO}
    ...
    \subsection{RUP}
        Segundo \cite{piske2003rup}, o RUP (Rational Unified Process) é uma metodologia com fins de desenvolvimento de software. Assim como todas as metodologias, o RUP possui uma estrutura bem definida, possuindo conceitos, práticas e regras. O conceito de \textit{best pratices} (melhores práticas), é um dos pilares principais do RUP que visa reduzir riscos e possibilitar um desenvolvimento mais eficiênte do projeto, através de regras e práticas. De acordo com \cite{tccPaulo} O RUP lista como efetutuar um efetivo desenvolvimento de software sempre utilizando as boas práticas de desenvolvimento que são:
            
        \begin{enumerate}
                \item \textbf{Desenvolvimento iterativo de software:} Atualmente, os software estão complexos demais para definidir todos os problemas inicialmente. Por isso, o RUP utiliza uma abordagem via iterações, que, a decorrer do desenvolvimento do proejto, qualquer alterção pode ser efetuada.
                
                \item \textbf{Gerenciamento de requisitos:} O RUP auxilia na organização e documentação dos requisitos. A utilização de casos de uso é uma ótima abordagem para se obter requitos funcionais e garantir que tais seguirão durante o desenvolvimento do software.
                
                \item \textbf{Modelagem visual de software:} A utilização de modelagens visuais no desenvolvimento do software contribuem para um melhor entendimento do tal como a interação entre componentes ou elementos. No RUP se usa a liguamgem UML.
                
                \item \textbf{Verificação da qualidade do software:} A utilização de modelagens visuais no desenvolvimento do software contribuem para um melhor entendimento do tal como a interação entre componentes ou elementos. No RUP se usa a liguamgem UML.
        \end{enumerate}
