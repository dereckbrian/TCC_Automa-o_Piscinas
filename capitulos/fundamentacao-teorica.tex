...
\section{FERRAMENTAS UTILZIADAS PARA AUTOMAÇÃO}
    ...
    \subsection{COMPONENTES FÍSICOS E DE CONTROLE (HARDWARE)}
        ...
        \subsubsection*{Raspberry Pi}
            Segundo \cite{juca2018aplicaccoes}, o raspberry possuindo o tamanho de um cartão de crédito, é considerado um dos menores computadores do mundo. Possuí uma entrada HDMI\footnote{É uma tecnologia sem fio que permite a troca de dados entre dispositivos de curto alcance} a fim de conectar com TVs e monitores. Seus principais componentes são: portas USB (\textit{High-Definition Multimedia Interface}), pinos de conexão, entrada de Ethernet, entrada P2 para saída de áudio, placa de rede para conexões Wi-fi e placa bluetooth para conexões sem fio.

            Todo seu funcionamento é integrado por meio de uma única placa. Em vista disso, seu custo de hardware é extremamente baixo, junto com o sistema operacional baseado em Linux. Sendo capaz de executar tudo o que um computador convencional pode fazer como acessar a internet, processar textos, ou rodar vídeos com alta definição, o principal objetivo do raspberry é promover o ensino de Ciência da Computação. Além de tudo, o raspberry pode ser capaz de interagir com o ambiente externos através de sensores, utilizados os conectores chamados de pinos. 
