...
Durante os testes de integração, o sistema de atuadores respondeu conforme o esperado, com o acionamento da bomba via relé ocorrendo sem atrasos perceptíveis. Entretanto, nas etapas iniciais de validação, foi indentificado um problema: o acionamento da bomba gerava ruídos eletromagnéticos e picos de tensão (\textit{back EMF}) que interferiam no circuito do microcontrolador, comprometendo a estabilidade das leituras dos sensores e da própria bomba.
...
\begin{figure}[H]
    ...
    \includegraphics[width=1.0\textwidth]{imagens/dashboardSite.png}
    \caption*{Fonte: Autoria própria (2025).}
\end{figure}
