...
A análise comparativa evidencia a existência de uma lacuna no desenvolvimento de sistemas de baixo custo capazes de realizar simultaneamente o monitoramento analítico de pH e turbidez, com atuação autônoma e conectividade via Internet. Essa lacuna, observada de forma recorrente nos trabalhos analisados, é diretamente abordada pela proposta apresentada neste estudo.