...
A seguir, apresentamos os trechos essenciais dos scripts desenvolvidos para o funcionamento do sistema de automação, demonstrando a integração entre as camadas de \textit{Firmware}, \textit{Gateway} e Aplicação.
